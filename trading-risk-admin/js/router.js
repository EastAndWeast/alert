...
var Router = {
    routes: {
        ...
        'rules-pricing': { title: 'pricing', breadcrumb: 'rules_manage / pricing', render: function () { return RulesModule.renderPricing(); } },
        'rules-volatility': { title: 'volatility', breadcrumb: 'rules_manage / volatility', render: function () { return RulesModule.renderVolatility(); } },
