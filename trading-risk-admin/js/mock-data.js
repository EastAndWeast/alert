...
const MockData = {
    ...
    rules: [
        ...
        // 11. Blacklist (原生模式)
        { rule_id: 'R095', source_id: 'DS001', rule_type: 'blacklist', name: 'IP/CID 黑名单 - MT4 Server 1', description: '封锁已确认恶意账户及数据中心IP', icon: '🚫', enabled: true, parameters: { ip_list: ['45.33.32.156', '103.224.182.240', '198.199.77.88'], cid_list: ['C-889923', 'C-334411'], block_reason: '恶意对冲套利/Scalping' }, trigger_action: 'alert', triggered_count: 7 },
        { rule_id: 'R096', source_id: 'DS002', rule_type: 'blacklist', name: 'IP/CID 黑名单 - MT5 Server', description: '封锁 MT5 服务器已知恶意节点', icon: '🚫', enabled: true, parameters: { ip_list: ['165.22.187.44', '104.21.66.33'], cid_list: ['C-778800'], block_reason: 'DigitalOcean 数据中心节点' }, trigger_action: 'alert', triggered_count: 3 },
        // 12. Fake IP (原生模式)
    ...
    alerts: [
        // 1. Large Trade (手数)
        { server_timezone_offset: -300, alert_id: 'A001', source_id: 'DS001', rule_type: 'large_trade_lots', rule_id: 'R001', account_id: 'ACC001', product: 'XAUUSD', trigger_time: '2024-01-15 10:30:15', trigger_value: 8.5, status: 'new', platform: 'MT4', details: { direction: 'BUY', threshold: 5.0 } },
        { server_timezone_offset: 0, alert_id: 'A002', source_id: 'DS002', rule_type: 'large_trade_lots', rule_id: 'R002', account_id: '88888888', product: 'XAUUSD', trigger_time: '2024-01-15 11:15:22', trigger_value: 6.0, status: 'reviewed', platform: 'MT5', details: { direction: 'SELL', threshold: 3.0 } },
        { server_timezone_offset: 660, alert_id: 'A003', source_id: 'DS003', rule_type: 'large_trade_lots', rule_id: 'R003', account_id: '99999999', product: 'BTCUSD', trigger_time: '2024-01-15 14:20:05', trigger_value: 2.5, status: 'new', platform: 'MT5', details: { direction: 'BUY', threshold: 1.0 } },

        // 2. Large Trade (USD)
        { server_timezone_offset: -300, alert_id: 'A010', source_id: 'DS001', rule_type: 'large_trade_usd', rule_id: 'R010', account_id: '12345678', product: 'EURUSD', trigger_time: '2024-01-15 09:45:30', trigger_value: 125000, status: 'new', platform: 'MT4', details: { lots: 2.5, account_currency: 'USD', rate_used: 1.0, account_type: 'standard' } },
        { server_timezone_offset: 0, alert_id: 'A011', source_id: 'DS002', rule_type: 'large_trade_usd', rule_id: 'R011', account_id: '66666666', product: 'XAUUSD.m', trigger_time: '2024-01-15 10:55:18', trigger_value: 5500, status: 'reviewed', platform: 'MT5', details: { lots: 1.0, account_currency: 'USC', rate_used: 1.0, account_type: 'cent' } },

        // 3. Liquidity Trade (拆单监控)
        { server_timezone_offset: -300, alert_id: 'A020', source_id: 'DS001', rule_type: 'liquidity_trade', rule_id: 'R020', account_id: '12345678', product: 'XAUUSD', trigger_time: '2024-01-15 11:30:00', trigger_value: 15.5, status: 'new', platform: 'MT4', details: { order_count: 8, time_window: 60, direction: 'BUY', category: 'Metals' } },
        { server_timezone_offset: 660, alert_id: 'A021', source_id: 'DS003', rule_type: 'liquidity_trade', rule_id: 'R021', account_id: '77777777', product: 'BTCUSD', trigger_time: '2024-01-15 13:45:22', trigger_value: 12.0, status: 'new', platform: 'MT5', details: { order_count: 6, time_window: 120, direction: 'SELL', category: 'Crypto' } },

        // 4. Scalping (刷单监控)
        { server_timezone_offset: -300, alert_id: 'A030', source_id: 'DS001', rule_type: 'scalping', rule_id: 'R030', account_id: '88888888', product: 'EURUSD', trigger_time: '2024-01-15 10:00:45', trigger_value: 35, status: 'new', platform: 'MT4', details: { profit_usd: 850, lots: 2.0, threshold: 180 } },
        { server_timezone_offset: 0, alert_id: 'A031', source_id: 'DS002', rule_type: 'scalping', rule_id: 'R031', account_id: '55555555', product: 'GBPUSD', trigger_time: '2024-01-15 11:02:18', trigger_value: 28, status: 'reviewed', platform: 'MT5', details: { profit_usd: 520, lots: 1.5, threshold: 120 } },
        ...
        // 7. Volatility
        { server_timezone_offset: 0, alert_id: 'A051', source_id: 'DS002', rule_type: 'volatility', rule_id: 'R051', account_id: 'SYSTEM', product: 'EURUSD', trigger_time: '2024-01-15 16:22:05', trigger_value: 85, status: 'new', platform: 'MT5', details: { alert_subtype: 'VOLATILITY', change_points: 85, time_window: 'M1' } },

        // 7. NOP Limit (净头寸限额)
        { server_timezone_offset: -300, alert_id: 'A060', source_id: 'DS001', rule_type: 'nop_limit', rule_id: 'R060', account_id: 'SYSTEM', product: 'XAUUSD', trigger_time: '2024-01-15 13:00:05', trigger_value: 6200, status: 'new', platform: 'MT4', details: { threshold: 5000, net_position: 62, direction: 'LONG' } },
        { server_timezone_offset: 660, alert_id: 'A061', source_id: 'DS003', rule_type: 'nop_limit', rule_id: 'R061', account_id: 'SYSTEM', product: 'BTCUSD', trigger_time: '2024-01-15 15:45:30', trigger_value: 1250, status: 'reviewed', platform: 'MT5', details: { threshold: 1000, net_position: 12.5, direction: 'SHORT' } },

        // 8. Watch List (观察名单)
        { server_timezone_offset: -300, alert_id: 'A070', source_id: 'DS001', rule_type: 'watch_list', rule_id: 'R070', account_id: '123456', product: 'XAUUSD', trigger_time: '2024-01-15 10:05:12', trigger_value: 5.0, status: 'new', platform: 'MT4', details: { action: 'OPEN_TRADE', direction: 'BUY', priority: 'HIGH' } },
        { server_timezone_offset: 0, alert_id: 'A071', source_id: 'DS002', rule_type: 'watch_list', rule_id: 'R070', account_id: '888888', product: 'EURUSD', trigger_time: '2024-01-15 11:22:45', trigger_value: 2.0, status: 'new', platform: 'MT5', details: { action: 'OPEN_TRADE', direction: 'SELL', priority: 'HIGH' } },
        { server_timezone_offset: 660, alert_id: 'A072', source_id: 'DS003', rule_type: 'watch_list', rule_id: 'R071', account_id: '999999', product: 'BTCUSD', trigger_time: '2024-01-15 14:55:08', trigger_value: 1.5, status: 'reviewed', platform: 'MT5', details: { action: 'OPEN_TRADE', direction: 'BUY', priority: 'INFO' } },

        // 9. Reverse Positions (反向开仓)
        { server_timezone_offset: -300, alert_id: 'A080', source_id: 'DS001', rule_type: 'reverse_positions', rule_id: 'R080', account_id: '12345678', product: 'XAUUSD', trigger_time: '2024-01-15 11:45:05', trigger_value: 3, status: 'new', platform: 'MT4', details: { close_direction: 'BUY', open_direction: 'SELL', close_lots: 2.0, open_lots: 2.5 } },
        { server_timezone_offset: 660, alert_id: 'A081', source_id: 'DS003', rule_type: 'reverse_positions', rule_id: 'R081', account_id: '99999999', product: 'BTCUSD', trigger_time: '2024-01-15 16:02:18', trigger_value: 2, status: 'new', platform: 'MT5', details: { close_direction: 'SELL', open_direction: 'BUY', close_lots: 0.8, open_lots: 1.0 } },

        // 10. Deposit & Withdrawal (出入金监控)
        { server_timezone_offset: -300, alert_id: 'A090', source_id: 'DS001', rule_type: 'deposit_withdrawal', rule_id: 'R090', account_id: '88888888', product: 'N/A', trigger_time: '2024-01-15 09:00:00', trigger_value: 50000, status: 'new', platform: 'MT4', details: { type: 'DEPOSIT', comment: 'External Deposit', currency: 'USD' } },
        { server_timezone_offset: 0, alert_id: 'A091', source_id: 'DS002', rule_type: 'deposit_withdrawal', rule_id: 'R090', account_id: '66666666', product: 'N/A', trigger_time: '2024-01-15 14:30:22', trigger_value: 25000, status: 'reviewed', platform: 'MT5', details: { type: 'WITHDRAWAL', comment: 'Withdraw to Bank', currency: 'EUR' } },
        { server_timezone_offset: 660, alert_id: 'A092', source_id: 'DS003', rule_type: 'deposit_withdrawal', rule_id: 'R091', account_id: '77777777', product: 'N/A', trigger_time: '2024-01-15 16:45:55', trigger_value: 85000, status: 'new', platform: 'MT5', details: { type: 'DEPOSIT', comment: 'External Deposit Wire', currency: 'USD' } },
        // 11. Blacklist 告警记录
        { server_timezone_offset: -300, alert_id: 'A095', source_id: 'DS001', rule_type: 'blacklist', rule_id: 'R095', account_id: 'C-889923', product: 'N/A', trigger_time: '2024-01-16 09:05:11', trigger_value: 'C-889923', status: 'new', platform: 'MT4', details: { match_type: 'CID', matched_value: 'C-889923', reason: '多次恶意刷返佣，累计损失 $12,400', ip_at_login: '120.52.73.88' } },
        { server_timezone_offset: -300, alert_id: 'A096', source_id: 'DS001', rule_type: 'blacklist', rule_id: 'R095', account_id: 'ACC003', product: 'N/A', trigger_time: '2024-01-16 14:22:35', trigger_value: '45.33.32.156', status: 'new', platform: 'MT4', details: { match_type: 'IP', matched_value: '45.33.32.156', reason: '2025年恶意对冲套利，同一IP下多账号反向开仓' } },
        // 12. Fake IP 告警记录 (增强版)
        { server_timezone_offset: -300, alert_id: 'A100', source_id: 'DS001', rule_type: 'fake_ip', rule_id: 'R100', account_id: 'C-789900', product: 'N/A', trigger_time: '2024-01-15 11:30:15', trigger_value: '165.22.187.44', status: 'new', platform: 'MT4', details: { alert_type: 'datacenter', ip: '165.22.187.44', isp_type: 'DigitalOcean Data Center', provider: 'DigitalOcean (ASN 14061)', current_city: 'Frankfurt', current_country: 'DE', base_location: '中国 (注册地)', account_id: 'C-789900' } },
        { server_timezone_offset: -300, alert_id: 'A101', source_id: 'DS001', rule_type: 'fake_ip', rule_id: 'R100', account_id: 'C-334555', product: 'N/A', trigger_time: '2024-01-15 12:15:22', trigger_value: '203.11.48.12', status: 'new', platform: 'MT4', details: { alert_type: 'roaming', ip: '203.11.48.12', current_city: 'Sydney', current_country: 'AU', base_location: 'Shanghai, CN', isp_type: 'Residential (Telstra)' } },
        { server_timezone_offset: 0, alert_id: 'A102', source_id: 'DS001', rule_type: 'fake_ip', rule_id: 'R100', account_id: 'C-334111', product: 'N/A', trigger_time: '2024-01-15 16:05:43', trigger_value: '104.21.66.33', status: 'reviewed', platform: 'MT4', details: { alert_type: 'datacenter', ip: '104.21.66.33', isp_type: 'Cloudflare CDN', provider: 'Cloudflare (ASN 13335)', current_city: 'San Francisco', current_country: 'US', base_location: '中国 (注册地)' } },
