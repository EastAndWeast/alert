...
const MockData = {
    ...
    rules: [
        ...
        { rule_id: 'R010', source_id: 'DS001', rule_type: 'large_trade_usd', name: 'Large Trade (USD)', description: '监控单笔开仓USD等值金额超过阈值', icon: '💵', enabled: true, parameters: { usd_value_threshold: 50000.0, cent_account_groups: ['*CENT*', '*MICRO*'], min_alert_interval: 60 }, trigger_action: 'alert', triggered_count: 15 },
        { rule_id: 'R011', source_id: 'DS003', rule_type: 'large_trade_usd', name: 'Large Trade (USD)', description: '监控单笔开仓USD等值金额超过阈值', icon: '💵', enabled: true, parameters: { usd_value_threshold: 100000.0, cent_account_groups: [], min_alert_interval: 120 }, trigger_action: 'alert', triggered_count: 8 },
        ...
        { rule_id: 'R061', source_id: 'DS002', rule_type: 'nop_limit', name: 'NOP Limit', description: '监控产品净头寸超限', icon: '📐', enabled: true, parameters: { symbol_name: 'EURUSD', platform_type: 'MT5', nop_threshold: 10000.0, calculation_frequency: 5, alert_cooldown: 300 }, trigger_action: 'alert', triggered_count: 3 },
        { rule_id: 'R062', source_id: 'DS003', rule_type: 'nop_limit', name: 'NOP Limit', description: '监控产品净头寸超限', icon: '📐', enabled: true, parameters: { symbol_name: 'BTCUSD', platform_type: 'MT5', nop_threshold: 100.0, calculation_frequency: 10, alert_cooldown: 600 }, trigger_action: 'alert', triggered_count: 2 },
